...
! function(global, factory) {
    ...
    proto.loadDeps = function() {
        if (0 == this.deps.length) return emar.release ? void EventMgr.emit(this.name + ":loaded") : this.name == 'emar_0' ? void EventMgr.emit(this.name + ":loaded") : void 0;
        var me = this;
        ...
        emar.release && EventMgr.emit(this.name + ":loaded")
    }
